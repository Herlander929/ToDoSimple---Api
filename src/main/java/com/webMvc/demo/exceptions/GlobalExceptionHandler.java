package com.webMvc.demo.exceptions;
...
for (FieldError fieldError : methodArgumentNotValidException.getBindingResult().getFieldErrors()) {
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        return buildErrorResponse(
                ...
                "Failed to validate element", HttpStatus.UNPROCESSABLE_ENTITY,
                request);
    }
    ...
    public ResponseEntity<Object> handleObjectNotFoundException(
        ...
        return buildErrorResponse(
                ...
                "Failed to find the requested element", HttpStatus.NOT_FOUND,
                request);
    }
    ...
    public ResponseEntity<Object> handleDataBindingViolationException(
        DataBindViolationException dataBindingViolationException,
            WebRequest request) {
        log.error("Failed to save entity with associated data", dataBindingViolationException);
        return buildErrorResponse(
                dataBindingViolationException,
                "Failed to save entity with associated data",HttpStatus.CONFLICT,
                request);
    }
